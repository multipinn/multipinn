...
from examples.wave_1D_1C.problem import exact_solution, problem_wave1D1C
...
def train(cfg: DictConfig):
    ...
    conditions, input_dim, output_dim = problem_wave1D1C(cfg.problem.c)
