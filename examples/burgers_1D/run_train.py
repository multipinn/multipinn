...
from examples.burgers_1D.problem import problem_burgers1D
from multipinn import *
from multipinn.metrics import PointCloudMetric, l_inf_error, norm_error
...
def train(cfg: DictConfig):
    ...
    conditions, input_dim, output_dim = problem_burgers1D()
    ...
    metric = PointCloudMetric.from_files(
        cfg.paths.points, cfg.paths.val, metric=norm_error, field_names=["u"]
    )
