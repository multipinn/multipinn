...
from examples.laplace_3D_1C_curved_mesh.problem import problem_3D1C_laplace_curved_mesh
...
def laplace(cfg: DictConfig):
    ...
    conditions, input_dim, output_dim = problem_3D1C_laplace_curved_mesh(
