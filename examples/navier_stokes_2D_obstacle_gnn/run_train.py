...
from examples.navier_stokes_2D_obstacle_gnn.problem import (
    navier_stokes_derivatives,
    navier_stokes_equation_with_obstacle,
)
from multipinn import *
from multipinn.mesh import MeshDomain
...
def train(cfg: DictConfig):
    ...
    model.unpack_output_func = navier_stokes_derivatives
    ...
    mesh = MeshDomain.from_mesh_files(
        cfg.paths.nodes, cfg.paths.edges, conditions, cfg.mesh.k
    )

    pinn = GPINN(model=model, conditions=conditions, mesh=mesh)
