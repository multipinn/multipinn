...
from examples.heat_2D_CG.problem import problem
...
def train(cfg: DictConfig):
    ...
    generator_init = Generator(
        n_points=cfg.generator.init_points, sampler=cfg.generator.sampler
    )

    generator_domain.use_for(conditions[0])
    generator_bound.use_for(conditions[1:-1])
    generator_init.use_for(conditions[-1])
