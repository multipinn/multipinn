...
from examples.navier_stokes_2D_narrowing_pipe.problem import (
    navier_stokes_2D_narrowing_pipe,
)
...
def train(cfg: DictConfig):
    ...
    conditions, input_dim, output_dim = navier_stokes_2D_narrowing_pipe(
        re=cfg.problem.re
    )
