...
from examples.navier_stokes_2D_obstacle_adaptive.problem import (
...
def train(cfg: DictConfig):
    ...
    generator_domain = AdaptiveGeneratorRAD(
        n_points=cfg.generator.domain_points, density_rec_points_num=20000,
    )
    generator_bound = AdaptiveGeneratorRAG(
        n_points=cfg.generator.bound_points, density_rec_points_num=2000,
    )
